        ...
        <Row>
          <ImageTextBig
            ...
            description={(
              <p>
                {
                  t('about:Привет, меня зовут Андрей и я использую эфирные масла для того, чтобы' +
                    ' помогать людям во многих аспектах. Именно желание помочь и сделать жизнь' +
                    ' лучше движет мною. А теперь, давайте по порядку...')
                }
              </p>
            )}
            button={{
