    ...
    <Container>
      <Row>
        ...
        <ContentBlock className={s.content}>
          <p>
            Рекламации по поводу несоответствующего выполнения заказа принимаются к рассмотрению в
            течение 20 часов с момента получения заказа. Рекламация должна быть оформлена заказчиком
            и в ней обязательно нужно указать номер заказа.
          </p>
          <p>
