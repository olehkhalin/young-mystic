    ...
    <BaseLayout>
      <Container>
        <Row className={s.row}>
          <FirstScreen />
          <TitleDescription
            title={t('home:Эфирные масла')}
            description={t('home:Масла разных растений по разному воздействуют на человека. Мой сайт рассказывает об их драгоценных свойствах и способах применения.')}
            className={s.title}
          />
          <ImageTextBig
            ...
            button={{
              link: '/oil-life',
              label: t('common:Узнать подробнее'),
            }}
          />
          <ImageTextBig
            className={s.blockImage}
